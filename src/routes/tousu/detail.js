...
class Detail extends Component {
  ...
  componentDidMount() {
    const e = this.props.match.params.id;
    this.props.dispatch({
      type: "tousu/getDetail",
      payload: e
    });
  }
  render() {
    const a = this.props.tousu.value;
    const e = this.props.match.params.id;
    console.log(a);
    let value =
      a === undefined
      ...
      <div>
        <div>
          <div>
            <span>内容</span>
            <br />
            <span>事项</span> <span>{value.stssx}</span>
            <WingBlank size="lg">
              <WhiteSpace size="lg" />
              <Button
                onClick={() =>
...
export default connect(({ tousu }) => ({ tousu }))(Details);
